                ...
                createNodeAPI(this.createNodeParams)
                    .then(res => {
                        if(res.data.code == 200){
                            ...
                            // })
                            $.ajax({
                                url: `http://8.140.145.144:5000/addNodeName/${this.createNodeParams.name}`,
                                type: "GET",
                                ...
                                success: function(data){
                                    console.log("addNodeNameToDir",data)
                                },
                                error: function(){
                                    console.log("addNodeNameToDirError")
                                }
                            });
                            ...
                            // })
                            $.ajax({
                                url: `http://8.140.145.144:5000/addTypeName/${this.createNodeParams.type}`,
                                type: "GET",
                                // contentType: "application/x-www-form-urlencoded",
                                // data: {
                                //     question:question
                                // },
                                success: function(data){
                                    console.log("addTypeNameToDir",data)
                                },
                                error: function(){
                                    console.log("addTypeNameToDirError")
                                }
                            });
