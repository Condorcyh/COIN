                ...
                <div class="fixed-tools">
                    ...
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item @click.native="exportCsv">导出csv</el-dropdown-item>
...
<!--                <el-scrollbar style="width: 100%;height: 100%">-->
                    <svg id="kgGraph" width="1400" height="700"></svg>
<!--                </el-scrollbar>-->
            </div>
            <div class="graphInfo">
...
<script>
    ...
    import {downloadAPI, exportGraphCSVAPI, exportGraphXMLAPI} from "../../api/file";
    ...
    export default {
        ...
        methods:{
            ...
            //=================================导出csv部分=============================
            exportCsv(){
                exportGraphCSVAPI(this.selectedDomain.id).then(res => {
                    if(res.data.code == 200){
                        this.download(2);
                    }else{
                    }
            ...
            download(type){
                downloadAPI(this.selectedDomain.name,type).then(res => {
                    if(res.status == 200){
                        let blob = new Blob([res.data], {type: "application/x-download"}), // 此处为生成doc
                            link = document.createElement("a"),
                            href = window.URL.createObjectURL(blob);
                        link.href = href;
                        link.download = this.selectedDomain.name+(type==1?".xml":".csv");
